...
-define(TEST_ENVS, [
    ...
    {cluster_manager_generated_config_file, "/etc/cluster_manager/generated.config"},
    ...
    {op_worker_generated_config_file, "/etc/op_worker/generated.config"},
    ...
    {oz_worker_generated_config_file, "/etc/oz_worker/generated.config"},
