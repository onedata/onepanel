...
%%% @end
%%%-------------------------------------------------------------------
-module(cluster_services_test_SUITE).
-author("Bartosz Walkowicz").
...
ones3_stop_start(Config) ->
    ...
    #node_details{hostname = Host1} = cluster_deployment_test_utils:infer_node_details(OpPanelNode1),
    #node_details{hostname = Host2} = cluster_deployment_test_utils:infer_node_details(OpPanelNode2),
