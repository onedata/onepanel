    ...
    NewState =
        try
            receive
                ...
                {'EXIT', Pid, _} ->
                    onepanel_gui_utils:message(<<"top_menu">>, error, <<"Cannot register in <i>Global Registry</i>.<br>Please try again later.">>),
...
event(register) ->
    case gui_ctx:postback_param(<<"client_name">>) of
        <<>> ->
            onepanel_gui_utils:message(<<"top_menu">>, error, <<"Please enter provider name.">>);
        ClientName ->
