...
converted_test_() -> [[
    ?_assertEqual(<<"value1">>, onepanel_utils:get_converted([key1], Container, binary)),
    ...
    ?_assertEqual(<<"value1">>, onepanel_utils:get_converted([key1], Container, binary, default)),
    ?_assertEqual({ok, <<"value1">>}, onepanel_utils:find_converted([key1], Container, binary)),
