...
PRIMARY_IMAGE='docker.onedata.org/onepanel-gui:VFS-4559-fix-actions-display-in-onepanel'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/onepanel-gui:VFS-4559-fix-actions-display-in-onepanel'
