...
PRIMARY_IMAGE='docker.onedata.org/onepanel-gui:VFS-4798-refresh-provider-name-18.07'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/onepanel-gui:VFS-4798-refresh-provider-name-18.07'
