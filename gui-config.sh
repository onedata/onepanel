...
PRIMARY_IMAGE='docker.onedata.org/onepanel-gui:VFS-5301-webdav-optional-fix-18.02.1'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/onepanel-gui:VFS-5301-webdav-optional-fix-18.02.1'
