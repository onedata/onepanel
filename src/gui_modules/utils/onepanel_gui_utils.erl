...
-export([body/1, body/2, body/3, top_menu/1, top_menu/2, top_menu/3, top_menu/4,
    account_settings_tab/1, logotype_footer/0, nav_buttons/1, nav_buttons/2]).
...
top_menu(ActiveTabID, ActiveLinkID, Submenu, Spinner) ->
    {MenuCaptions, MenuIcons} = get_menu_captions_and_icons(ActiveTabID, ActiveLinkID),
...
%% get_menu_captions_and_icons/2
%% ====================================================================
%% @doc Returns menu captions and icons.
%% @end
-spec get_menu_captions_and_icons(ActiveTabID :: atom(), ActiveLinkID :: term()) -> Result when
    Result :: {MenuCaptions :: [{atom, #li{}}], MenuIcons :: [{atom(), #li{}}]}.
%% ====================================================================
get_menu_captions_and_icons(ActiveTabID, ActiveLinkID) ->
