...
%%%-------------------------------------------------------------------
%%% @doc
%%% Gets auto-cleaning status for a space.
%%% TODO VFS-13070 test endpoint
%%% @end
%%%-------------------------------------------------------------------
-module(space_auto_cleaning_status_get_middleware_handler).
-author("Bartosz Walkowicz").
...
process(#onp_req_state{ctx = #onp_req_ctx{gri = #gri{id = SpaceId}}}) ->
    ...
    middleware_handler_utils:service_call(?SERVICE_OP, get_auto_cleaning_status, Ctx).
