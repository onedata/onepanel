...
%%%-------------------------------------------------------------------
%%% @doc
%%% Returns this Oneprovider details (op_panel only).
%%% @end
%%%-------------------------------------------------------------------
-module(provider_instance_get_middleware_handler).
-author("Bartosz Walkowicz").
...
process(_) ->
    middleware_handler_utils:service_call(?SERVICE_OP, get_details).
